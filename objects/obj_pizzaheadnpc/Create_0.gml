...
spd = 10
parryable = 1
function player_hurt_gml_Object_obj_pizzaheadnpc_Create_0(argument0, argument1) //player_hurt_gml_Object_obj_pizzaheadnpc_Create_0
{
    if (!collisioned)
    {
...
function parry_gml_Object_obj_pizzaheadnpc_Create_0() //parry_gml_Object_obj_pizzaheadnpc_Create_0
{

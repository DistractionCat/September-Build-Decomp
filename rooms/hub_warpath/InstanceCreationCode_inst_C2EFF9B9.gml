if (global.levelcomplete && (!global.warcutscene))
{
    ...
    currentroom = room
    explosion_func = function(argument0, argument1) //anon_gml_RoomCC_hub_warpath_4_Create_127_gml_RoomCC_hub_warpath_4_Create
    {
...
], [cutscene_change_room, 59], [cutscene_set_player_pos, 1350, 200], [function() //anon_gml_RoomCC_hub_warpath_4_Create_1636_gml_RoomCC_hub_warpath_4_Create
    {
...
], [explosion_func, 1342, 385], [cutscene_wait, 3], [explosion_func, 1342, 477], [cutscene_wait, 3], [explosion_func, 1342, 531], [cutscene_wait, 40], [cutscene_change_room, 142], [cutscene_set_player_pos, 300, 300], [cutscene_wait, 50], [explosion_func, 267, 4], [cutscene_wait, 3], [explosion_func, 267, 63], [cutscene_wait, 3], [explosion_func, 267, 125], [cutscene_wait, 3], [cutscene_wait, 100], [cutscene_change_room, currentroom], [cutscene_set_player_visible, 1], [function() //anon_gml_RoomCC_hub_warpath_4_Create_2566_gml_RoomCC_hub_warpath_4_Create
    {
        with (obj_player)
        {
            state = states.normal
